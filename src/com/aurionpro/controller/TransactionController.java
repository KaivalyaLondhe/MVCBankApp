...
public class TransactionController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Get sender account number from email
            ...
            // Adjust receiver account number for credit and debit transactions
            ...
            // Check for sufficient balance in case of debit or money transfer
            ...
            if ("credit".equalsIgnoreCase(transactionType)) {
                ...
                updateBalance(connection, senderAccountNumber, amount, false); // Debit from sender
                updateBalance(connection, receiverAccountNumber, amount, true); // Credit to receiver
            }
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void updateBalance(Connection connection, String accountNumber, double amount, boolean isCredit) throws SQLException {
    ...
    private boolean hasSufficientBalance(Connection connection, String accountNumber, double amount) throws SQLException {
